...
# Опции выбора
roles = ["Product Owner", "Project Manager", "Tech Lead", "Business Analyst", "Developer", "QA"]
...
def success_level(team, events):
    ...
    ba_ok = any(p['role'] == "Business Analyst" and p['skill'] != "неадекватен" for p in team)
...
st.subheader("Добавьте участников и внешние события")
