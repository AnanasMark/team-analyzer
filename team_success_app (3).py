...
## **Прогноз успешности проекта: XX%**
[1–2 предложения с пояснением вероятности]

## Основные рекомендации
| Ключевая проблема | **Рекомендуемое решение** |
|------------------|---------------------------|
| ...              | ...                       |
...
**Наиболее неопределённые аспекты:**
- ...

**Уровень зрелости команды:** низкий / средний / высокий
