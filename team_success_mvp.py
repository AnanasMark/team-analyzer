...
deadline = st.selectbox("Срок реализации проекта/продукта", ["", "1 месяц", "3 месяца", "6 месяцев", "1 год"], index=0)
expectation = st.selectbox("Тип результата", ["", "Фича", "MVP", "Концепт", "Готовый продукт"], index=0)
